  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        primary: {
          DEFAULT: "hsl(227, 72%, 55%)",
          light: "hsl(223, 83%, 75%)",
          dark: "hsl(227, 72%, 40%)"
        },
        accent: {
          DEFAULT: "hsl(47, 95%, 64%)",
          light: "hsl(50, 92%, 80%)"
        },
        success: { DEFAULT: "hsl(145, 63%, 41%)", bg: "hsl(145, 63%, 95%)" },
        warning: { DEFAULT: "hsl(45, 88%, 52%)", bg: "hsl(45, 88%, 95%)" },
        danger: { DEFAULT: "hsl(359, 79%, 63%)", bg: "hsl(359, 79%, 95%)" },
        slate: {
          50: "#f9fafc",
          100: "#f1f5fa",
          300: "#cfd8ec",
      ...
      keyframes: {
        ...
        pulseSoft: { "0%": { opacity: 1 }, "50%": { opacity: 0.85 }, "100%": { opacity: 1 } }
      },
      animation: {
      ...
      spacing: { "7": "1.75rem", "9": "2.25rem", "14": "3.5rem" }
    }
  },
  plugins: [
    forms,
      ...
      theme: {
        DEFAULT: {
          css: {
            ...
            a: { color: "hsl(227,72%,55%)", textDecoration: "none", fontWeight: "500", transition: "color .25s ease" },
            "a:hover": { color: "hsl(227,72%,45%)", textDecoration: "underline" },
            h1: { fontWeight: "700", letterSpacing: "-0.5px", marginTop: "0", marginBottom: "0.35em" },
            h2: { fontWeight: "600", marginTop: "0", marginBottom: "0.4em" },
        ...
        dark: {
          css: {
            ...
            a: { color: "hsl(214, 100%, 75%)" },
            code: { background: "rgba(31,41,55,1)", color: "#e2e8f0" },
            pre: { background: "#0f172a" },
            blockquote: { backgroundColor: "rgba(20,34,66,0.6)", borderLeftColor: "hsl(214, 100%, 75%)" }
          }
        }
      }
    }),
