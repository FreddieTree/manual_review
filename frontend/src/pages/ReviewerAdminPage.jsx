...
export default function ReviewerAdminPage() {
    ...
    }, [loadReviewers, refreshFlag, debouncedSearch]);
    ...
    const sorted = useMemo(() => {
        ...
        return [...filtered].sort((a, b) => {
            const getVal = (item) => {
                if (sortKey === "active") return item.active ? 1 : 0;
    ...
    // whether form is valid for submit
    ...
    return (
        <div className="max-w-5xl mx-auto px-4 mt-8">
            <Card>
                ...
                {(feedback || error) && (
                    <div
                        role={feedback?.type === "error" || error ? "alert" : "status"}
                        aria-live="polite"
                        className={`mb-4 px-4 py-2 rounded border flex items-center justify-between ${feedback
                                ? feedback.type === "error"
                    ...
                    >
                        <div>{feedback ? feedback.message : error}</div>
                        <button
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div className="col-span-1">
                        <label className="block text-xs font-semibold mb-1" htmlFor="rev-email">
                            Email
                        </label>
                        <Input
                            id="rev-email"
                    ...
                    <div className="col-span-1">
                        <label className="block text-xs font-semibold mb-1" htmlFor="rev-name">
                            Name
                        </label>
                        <Input
                            id="rev-name"
                    ...
                    <div className="col-span-1 grid grid-cols-2 gap-2">
                        <div>
                            <label className="block text-xs font-semibold mb-1" htmlFor="rev-role">
                                Role
                            </label>
                            <Select
                                id="rev-role"
                        ...
                        <div>
                            <label className="block text-xs font-semibold mb-1" htmlFor="rev-active">
                                Active
                            </label>
                            <Select
                                id="rev-active"
                    ...
                    <div className="col-span-full md:col-span-2">
                        <label className="block text-xs font-semibold mb-1" htmlFor="rev-note">
                            Note
                        </label>
                        <Input
                            id="rev-note"
                    ...
                    <div className="col-span-full md:col-span-1 flex items-end gap-2">
                        <Button type="submit" disabled={submitting || !!validateForm()}>
                            {editingEmail
                                ? submitting
                                    ? "Updating…"
                                    : "Update Reviewer"
